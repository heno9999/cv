...
${underline}`);
  ...
  var fileToGenerativePart = async (file) => {
...
`;
  var analyzeCvPdf = async (file) => {
    ...
    try {
      ...
      throw new Error("\u0641\u0634\u0644 \u0641\u064A \u0645\u0639\u0627\u0644\u062C\u0629 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0633\u064A\u0631\u0629 \u0627\u0644\u0630\u0627\u062A\u064A\u0629 \u{1F916}");
    }
  };
  var rankCandidates = async (candidates, query) => {
    const model = "gemini-3-flash-preview";
    const slimCandidates = candidates.filter((c) => c && c.info).map((c) => ({
      id: c.id,
  ...
  var generateInterviewQuestions = async (candidate) => {
    const model = "gemini-3-flash-preview";
  ...
  var analyzeTruthLens = async (candidate) => {
    const response = await getAI().models.generateContent({
  ...
  var analyzePsychometric = async (candidate) => {
    const response = await getAI().models.generateContent({
      model: "gemini-3-flash-preview",
  ...
  var generateNegotiationStrategy = async (candidate) => {
    const response = await getAI().models.generateContent({
      model: "gemini-3-flash-preview",
  ...
  var generateManagerBrief = async (candidate) => {
    const response = await getAI().models.generateContent({
      model: "gemini-3-flash-preview",
  ...
  var generateSiteScenario = async (candidate, scenarioType) => {
  ...
  var analyzeProjectDNA = async (projectDesc, candidates) => {
  ...
  var searchWebForCandidates = async (query) => {
    const response = await getAI().models.generateContent({
      model: "gemini-3-pro-preview",
